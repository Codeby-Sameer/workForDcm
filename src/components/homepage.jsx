            ...
            <div className="col-md-12 col-lg-6">
              <div className="hero-slider-content">
                ...
                <div className="action-btns mt-3">
                  <a href="#" className="btn accent-solid-btn">Get Start Now</a>
                </div>
              </div>
            </div>
            <div className="col-md-12 col-lg-6">
                    ...
                    <div class="col-md-6 col-lg-4 box-1">
                        <div class="single-promo-block promo-hover-bg-2 hover-image p-5 text-center">
                            ...
                            <div class="promo-block-content">
                                ...
                                <a href="#" className="btn accent-solid-btn mt-3">Get Support</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 box-1 ">
          ...
          <div className="row justify-content-center">
            <div className="col-md-8 col-lg-8">
              <div className="call-to-action-content text-white text-center">
                ...
                <ul className="text-white row justify-content-center">
                  <li className="m-1"><span className="fa fa-check m-2"></span>Verified & Trained Workforce</li>
                  <li className="m-1"><span className="fa fa-check m-2"></span>Quick Deployment</li>
                </ul>
                <ul className="text-white row justify-content-center">
                  <li className="m-1"><span className="fa fa-check m-2"></span>Flexible Staffing Solutions</li>
                  <li className="m-1"><span className="fa fa-check m-2"></span>PAN-India Support</li>
                </ul>
                <a href="#" className="btn outline-white-btn mt-3">Get Support</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row justify-content-around align-items-center">
            ...
            <div className="col-md-4">
              <div className="action-btn text-lg-right text-sm-left">
                <a href="#" className="btn secondary-solid-btn">Contact With Us</a>
              </div>
            </div>
          </div>
        </div>
